...
{
    public class CasoDeUsoTramiteModificacion(IServicioAutorizacion auth, ITramiteRepositorio repo, TramiteValidador validador)
    {
        public void Ejecutar(int idTramite, Tramite modificado, int idEjecutor)
        {
            ...
            if(validador.validar(modificado, out resultado)) repo.modificarTramite(idTramite, modificado);
